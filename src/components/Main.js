...
export default function Main(props) {
  ...
  return (
    <main className="dashboard">
      ...
      {props.page === "home" ? <Home data={props.data} beers={props.beers} changePage={props.changePage} /> : null}

      {props.page === "beer" ? <Info data={props.data} beers={props.beers} changePage={props.changePage} /> : null}
